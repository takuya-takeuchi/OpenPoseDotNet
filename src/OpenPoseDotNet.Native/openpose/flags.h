...
MAKE_FUNC(face_detector, int32_t)
...
MAKE_FUNC(frame_undistort, bool)
...
MAKE_FUNC(hand_detector, int32_t)
...
MAKE_FUNC(upsampling_ratio, double)
MAKE_FUNC(write_coco_json_variant, int32_t)
MAKE_FUNC(write_coco_json_variants, int32_t)
...
MAKE_FUNC_STRING(camera_parameter_path)
...
MAKE_FUNC_STRING(prototxt_path)

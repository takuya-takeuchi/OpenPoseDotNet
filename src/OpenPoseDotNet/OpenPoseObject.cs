...
namespace OpenPoseDotNet
{
    ...
    /// </summary>
    public abstract class OpenPoseObject : IOpenPoseObject
    {

        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="OpenPoseObject"/> class with the specified value indicating whether this instance is disposable.
        /// </summary>
        /// <param name="isEnabledDispose">true if this instance is disposable; otherwise, false.</param>
        protected OpenPoseObject(bool isEnabledDispose = true)
        {
        ...
        /// <summary>
        /// Releases all resources used by this <see cref="OpenPoseObject"/>.
        /// </summary>
        public void Dispose()
        {

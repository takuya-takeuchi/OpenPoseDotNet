...
/*
 * This sample program is ported by C# from examples/tutorial_api_cpp/09_face_from_image.cpp.
*/
                ...
                using (var opTimer = OpenPose.GetTimerInit())
                {
                    using (var opWrapper = new Wrapper<Datum>(ThreadManagerMode.Asynchronous))
                    {
                        ...
                        using (var imageToProcess = Cv.ImRead(ImagePath))
                        {
                            ...
                            {
                                new Rectangle<float>( 330.119385f, 277.532715f, 48.717274f, 48.717274f), // Face 0
                                new Rectangle<float>( 24.036991f, 267.918793f, 65.175171f, 65.175171f),  // Face 1
                                new Rectangle<float>( 151.803436f, 32.477852f, 108.295761f, 108.295761f) // Face 2
                            };
